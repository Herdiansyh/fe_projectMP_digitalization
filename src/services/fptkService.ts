...
const fptkService = {
  ...
  getRequisitions: async (
    ...
    const response = await axiosInstance.get<any>("/fptk", { params });

    const payload = response.data.data; // flat: { data:[...], current_page, last_page, per_page, total }
  ...
  getPendingApprovals: async (params?: {
    ...
    const response = await axiosInstance.get<any>("/fptk/pending", {
      params,
    });
  ...
  getApproverActionHistory: async (params?: {
    ...
    const response = await axiosInstance.get<any>("/fptk/approval-history", {
      params,
    });
