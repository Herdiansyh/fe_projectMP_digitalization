...
// ── Shared helpers — sama persis dengan FptkDetail.tsx ──
...
const FptkApproval: React.FC = () => {
  ...
  // ── Fetch requisition for review ──
  const {
    data: responseData,
    isLoading: loading,
    isError,
  } = useFptkForReview(noReq ?? "", !!noReq);

  const requisition = responseData?.data ?? null;
